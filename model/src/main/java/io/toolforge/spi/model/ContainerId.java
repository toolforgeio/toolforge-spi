...
public class ContainerId implements Comparable<ContainerId> {
  ...
  public static ContainerId of(String s) {
    return new ContainerId(s);
  }

  @JsonCreator
  public static ContainerId fromString(String s) {
    return of(s);
  }

  private final String text;

  public ContainerId(String text) {
  ...
  public static final Comparator<ContainerId> COMPARATOR =
      Comparator.comparing(ContainerId::toString);
