...
public class SecretCursor {
  @JsonCreator
  public static SecretCursor fromString(String s) {
    return of(
        Integer.parseInt(new String(Base64.getUrlDecoder().decode(s), StandardCharsets.UTF_8)));
  }

  public static SecretCursor of(int offset) {
    return new SecretCursor(offset);
  }

  private final int offset;

  public SecretCursor(int offset) {
    if (offset < 0)
  ...
  public boolean equals(Object obj) {
    ...
    if (getClass() != obj.getClass())
      return false;
    SecretCursor other = (SecretCursor) obj;
